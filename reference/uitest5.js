...
app.whenReady().then(async () => {
  ...
  const uiOk = await win.webContents.executeJavaScript(`!!document.querySelector('#s-bank') && document.querySelector('#s-bank').value === 'RCBC'`);
  check('Settings screen renders with defaults', uiOk);
